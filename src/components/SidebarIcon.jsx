...
export default function SidebarIcon({ label }) {
  const size = "20";
  ...
  const getIcon = () => {
    switch (label) {
      ...
      case 'Treinamento':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M6 3v18"></path><path d="M18 3v18"></path><path d="M2 7h20"></path><path d="M2 17h20"></path><path d="M6 12h12"></path>
          </svg>
        );
      case 'Elementos':
        return (
      ...
      case 'Ichiraku Ramen':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M2 12h20"></path><path d="M12 12v10"></path><path d="M3 12a9 9 0 0 0 18 0"></path><path d="M12 4v4"></path><path d="M8 3v5"></path><path d="M16 5v3"></path>
          </svg>
        );
      default:
        return (
