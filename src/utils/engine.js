...
// Alguns componentes ainda importam estes nomes.
// Mantemos estes aliases para evitar erros de import.

export const calculateDefTaiBuk = (player) => calculateFisDef(player);
